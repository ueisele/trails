...
command make drive                # Drive the built page in a real browser (269 readings, ~400 s)
...
# see two parts of one report is 800. Send it to a file and grep the file. And it
