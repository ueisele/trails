...
command make drive                # Drive the built page in a real browser (253 readings, ~280 s)
...
#
# DRIVE ONCE AND READ THE FILE. `make drive` is 280 seconds; running it twice to
